...
from pysignfe.nfe.manual_401 import conscad_200
from pysignfe.nfe.manual_500 import ESQUEMA_ATUAL

DIRNAME = os.path.dirname(__file__)

class InfConsEnviado(conscad_200.InfConsEnviado):
    def __init__(self):
...
class InfCadRecebido(conscad_200.InfCadRecebido):
    def __init__(self):
        super(InfCadRecebido, self).__init__()
        self.ender    = Ender()


class InfConsRecebido(conscad_200.InfConsRecebido):
    def __init__(self):
