...
SVAN = {
    NFE_AMBIENTE_PRODUCAO: {
        ...
        WS_NFE_ENVIO_LOTE      : u'NfeRecepcao2/NfeRecepcao4.asmx',
        WS_NFE_CONSULTA_RECIBO : u'NFeRetRecepcao2/NFeRetRecepcao4.asmx',
        WS_NFE_CANCELAMENTO    : u'NFeCancelamento2/NFeCancelamento4.asmx',
        WS_NFE_EVENTO : u'RecepcaoEvento/RecepcaoEvento.asmx',
        #WS_NFE_CONSULTA_DESTINATARIO : u'NFeConsultaDest/NFeConsultaDest.asmx',
        WS_NFE_INUTILIZACAO    : u'NFeInutilizacao2/NFeInutilizacao4.asmx',
        WS_NFE_CONSULTA        : u'nfeconsulta2/nfeconsulta4.asmx',
        WS_NFE_SITUACAO        : u'NFeStatusServico2/NFeStatusServico4.asmx',
...
UFSP = {
    NFE_AMBIENTE_PRODUCAO: {
        ...
        WS_NFE_INUTILIZACAO      : u'ws/nfeinutilizacao4.asmx',
        WS_NFE_CONSULTA_PROTOCOLO: u'ws/nfeconsultaprotocolo4.asmx',
        WS_NFE_CONSULTA          : u'ws/nfeconsulta4.asmx',
        WS_NFE_SITUACAO          : u'ws/nfestatusservico4.asmx',
        WS_NFE_CONSULTA_CADASTRO : u'ws/cadconsultacadastro4.asmx',
        WS_NFE_EVENTO            : u'ws/nferecepcaoevento4.asmx',
        WS_NFE_AUTORIZACAO       : u'ws/nfeautorizacao4.asmx',
        WS_NFE_RET_AUTORIZACAO   : u'ws/nferetautorizacao4.asmx'
    },
    NFE_AMBIENTE_HOMOLOGACAO: {
